   ...
   <div class="col-md-12">
      ...
      <div class="col">
         ...
         <div class="pull-right">
            <a href="{{ url('cities/create')}}" class="btn btn-outline-dark" style="margin-left: 2px; margin-top: 15px;"><i class="fa fa-plus-square"></i></a><br><br>
         </div>
               ...
               <table class="table align-items-center table-flush"  >
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           <form action="{{ url('cities/' .$citie->id )}}" method="post">
                              @csrf
                              @method('DELETE')
                              <a href="{{ url('cities/' .$citie->id.'/edit')}}" class="btn btn-outline-success" ><i class="fa fa-edit"></i></a>
