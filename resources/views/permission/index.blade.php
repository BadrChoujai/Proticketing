      ...
      <div class="col">
         <div class="card shadow" style="margin-right:-12px; border-radius: 7px; padding-right:15px; padding-left:15px; margin-left:-12px;">
            <div class="pull-right">
               <a href="{{ url('permissions/create')}}" class="btn btn-outline-dark" style="margin-left: 2px; margin-top: 15px;"><i class="fa fa-plus-square"></i></a><br><br>
            </div>
                     ...
                     <tr>
                        ...
                        <td scope="col" class="relative px-6 py-3">
                           <form action="{{ url('permissions/' .$permission->id )}}" method="post">
                              @csrf
                              @method('DELETE')
                              <a href="{{ url('permissions/' .$permission->id.'/edit')}}" class="btn btn-outline-success" ><i class="fa fa-edit"></i></a>
